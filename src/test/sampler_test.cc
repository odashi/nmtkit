...
BOOST_AUTO_TEST_CASE(CheckFiniteMonotoneIteration) {
  ...
  NMTKit::Sampler sampler(
      "data/small.en.tok", "data/small.ja.tok", src_vocab, trg_vocab, false);
...
BOOST_AUTO_TEST_CASE(CheckInfiniteMonotoneIteration) {
  ...
  NMTKit::Vocabulary trg_vocab("data/small.ja.vocab");
  NMTKit::Sampler sampler(
      "data/small.en.tok", "data/small.ja.tok", src_vocab, trg_vocab, true);
  vector<vector<int>> expected_src = {
    {6, 41, 17, 90, 106, 37, 0, 364, 3},
    {159, 0, 13, 130, 0, 101, 332, 3},
    {6, 75, 12, 4, 145, 0, 3},
